...
const github = require('@actions/github');
  ...
  else if ( !issue.body.includes(checklist_item_1)||!issue.body.includes(checklist_item_2)||!issue.body.includes(checklist_item_3)) {
    var comment
    if (!issue.body.includes(checklist_item_1) && !issue.body.includes(checklist_item_2) && !issue.body.include(checklist_item_3)) {
